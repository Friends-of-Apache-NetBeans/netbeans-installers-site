# Distribution site for Apache NetBeans installers
...
to the frontmatter of the `index.html` page. The steps to achieve this are described in the [wiki](https://github.com/Friends-of-Apache-NetBeans/netbeans-installers/wiki)
